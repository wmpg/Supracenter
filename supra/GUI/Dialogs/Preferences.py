...
class PreferenceWindow(QWidget):
    ...
    def buildGUI(self):
        ...
        _, self.pso_max_iter = createLabelEditObj('Maximum Iterations', pso_tab_layout, 2, width=1, h_shift=0, tool_tip='', validate='int', default_txt='100')
        _, self.pso_swarm_size = createLabelEditObj('Swarm Size', pso_tab_layout, 3, width=1, h_shift=0, tool_tip='', validate='int', default_txt='100')
        # _, self.pso_run_times = createLabelEditObj('Run Times', pso_tab_layout, 7, width=1, h_shift=0, tool_tip='', validate='int', default_txt='1')
        _, self.pso_min_error = createLabelEditObj('Minimum Error', pso_tab_layout, 4, width=1, h_shift=0, tool_tip='', validate='float', default_txt='1e-8')
        _, self.pso_min_step = createLabelEditObj('Minimum Step', pso_tab_layout, 5, width=1, h_shift=0, tool_tip='', validate='float', default_txt='1e-8')
        _, self.pso_phi_p = createLabelEditObj('Phi_p', pso_tab_layout, 6, width=1, h_shift=0, tool_tip='', validate='float', default_txt='0.5')
        _, self.pso_phi_g = createLabelEditObj('Phi_g', pso_tab_layout, 7, width=1, h_shift=0, tool_tip='', validate='float', default_txt='0.5')
        _, self.pso_omega = createLabelEditObj('Omega', pso_tab_layout, 8, width=1, h_shift=0, tool_tip='', validate='float', default_txt='0.5')


        ray_trace_tab, ray_trace_layout = createTab(tab_widget, 'Ray-Tracing')
        _, self.pso_min_ang = createLabelEditObj('Horizontal Tolerance', ray_trace_layout, 1, width=1, h_shift=0, tool_tip='', validate='float', default_txt='330')
        _, self.pso_min_dist = createLabelEditObj('Vertical Tolerance', ray_trace_layout, 2, width=1, h_shift=0, tool_tip='', validate='float', default_txt='330')
