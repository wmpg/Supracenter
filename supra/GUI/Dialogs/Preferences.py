...
class PreferenceWindow(QWidget):
    ...
    def buildGUI(self):
        ...
        _, self.pso_min_ang = createLabelEditObj('Minimum Angle', pso_tab_layout, 3, width=1, h_shift=0, tool_tip='', validate='float', default_txt='1e-5')
        _, self.pso_min_dist = createLabelEditObj('Minimum Distance', pso_tab_layout, 4, width=1, h_shift=0, tool_tip='', validate='float', default_txt='1000.0')
