...
<head>
  ...
  <title>PyEphem Quick Reference &mdash; Western Meteor Physics Group Seismic and Infrasonic Meteor Program  documentation</title>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../../../../../../_sources/wmpl_venv/lib/python2.7/site-packages/pyephem-3.7.6.0-py2.7-linux-x86_64.egg/ephem/doc/quick.rst.txt" rel="nofollow"> View page source</a>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">ephem</span> <span class="k">import</span> <span class="o">*</span>
...
<span class="go">21:57:50.46 -13:17:37.2</span>
...
<div class="line-block">
<div class="line"><code class="docutils literal notranslate"><span class="pre">elong</span></code> — Elongation (angle to sun)</div>
...
<div class="line"><code class="docutils literal notranslate"><span class="pre">neverup</span></code> — whether is stays below the horizon</div>
</div>
</li>
<li><p>On Solar System bodies, also sets:</p>
<div class="line-block">
<div class="line"><code class="docutils literal notranslate"><span class="pre">hlon</span></code> — Heliocentric longitude (see next paragraph)</div>
<div class="line"><code class="docutils literal notranslate"><span class="pre">hlat</span></code> — Heliocentric latitude (see next paragraph)</div>
...
<div class="line-block">
<div class="line"><code class="docutils literal notranslate"><span class="pre">sublat</span></code> — Latitude (+N)</div>
<div class="line"><code class="docutils literal notranslate"><span class="pre">sublong</span></code> — Longitude (+E)</div>
<div class="line"><br /></div>
</div>
<div class="line"><code class="docutils literal notranslate"><span class="pre">elevation</span></code> — Height above sea level (m)</div>
...
<span class="go">72:19:44.8 134:14:25.3</span>
</pre></div>
</div>
<ul>
<li><p>Computes the position of the <code class="docutils literal notranslate"><span class="pre">Body</span></code>.</p></li>
...
<li><p>Sets all of the <code class="docutils literal notranslate"><span class="pre">Body</span></code> attributes listed in the previous section
(but <code class="docutils literal notranslate"><span class="pre">ra</span></code> and <code class="docutils literal notranslate"><span class="pre">dec</span></code> will get different values;
see below).</p></li>
...
<div class="line-block">
<div class="line"><code class="docutils literal notranslate"><span class="pre">az</span></code> — Azimuth east of north</div>
<div class="line"><code class="docutils literal notranslate"><span class="pre">alt</span></code> — Altitude above horizon</div>
</div>
</div>
</li>
<li><p>These apparent positions
include an adjustment to simulate atmospheric refraction
for the observer’s <code class="docutils literal notranslate"><span class="pre">temp</span></code> and <code class="docutils literal notranslate"><span class="pre">presure</span></code>;
...
for an observer sitting at the center of the earth.</p></li>
</ul>
</div></blockquote>
</div>
...
<li><p><code class="docutils literal notranslate"><span class="pre">EarthSatellite</span></code> elements:</p>
<div class="line-block">
<div class="line"><code class="docutils literal notranslate"><span class="pre">_epoch</span></code> — Reference epoch</div>
<div class="line"><code class="docutils literal notranslate"><span class="pre">_n</span></code> — Mean motion, in revolutions per day</div>
<div class="line"><code class="docutils literal notranslate"><span class="pre">_inc</span></code> — Inclination (°)</div>
<div class="line"><code class="docutils literal notranslate"><span class="pre">_raan</span></code> — Right Ascension of ascending node (°)</div>
<div class="line"><code class="docutils literal notranslate"><span class="pre">_e</span></code> — Eccentricity</div>
<div class="line"><code class="docutils literal notranslate"><span class="pre">_ap</span></code> — Argument of perigee at epoch (°)</div>
<div class="line"><code class="docutils literal notranslate"><span class="pre">_M</span></code> — Mean anomaly from perigee at epoch (°)</div>
<div class="line"><code class="docutils literal notranslate"><span class="pre">_decay</span></code> — Orbit decay rate in revolutions per day, per day</div>
<div class="line"><code class="docutils literal notranslate"><span class="pre">_drag</span></code> — Object drag coefficient in per earth radii</div>
<div class="line"><code class="docutils literal notranslate"><span class="pre">_orbit</span></code> — Integer orbit number of epoch</div>
</div>
</li>
</ul>
</div></blockquote>
...
<div class="line-block">
<div class="line"><code class="docutils literal notranslate"><span class="pre">lat</span></code> — Latitude (+N)</div>
<div class="line"><code class="docutils literal notranslate"><span class="pre">lon</span></code> — Longitude (+E)</div>
<div class="line"><code class="docutils literal notranslate"><span class="pre">elevation</span></code> — Elevation (m)</div>
</div>
<div class="line-block">
<div class="line"><code class="docutils literal notranslate"><span class="pre">temp</span></code> — Temperature (°C)</div>
...
<li><p>The <code class="docutils literal notranslate"><span class="pre">temp</span></code> defaults to 25°C.</p></li>
...
<li><p>XEphem can also perform Google geocoding lookups:</p></li>
</ul>
</div></blockquote>
<p> &gt;&gt;&gt; from ephem import cities
 &gt;&gt;&gt; ven = cities.lookup(‘Ven, Sweden’)</p>
<blockquote>
<div><ul class="simple">
<li><p>To avoid Google rate limits,
avoid performing any <code class="docutils literal notranslate"><span class="pre">lookup()</span></code> more than once —
instead, print the result to your screen
and then cut-and-paste the latitude and longitude into your code.</p></li>
<li><p>A <code class="docutils literal notranslate"><span class="pre">ValueError</span></code> signals a non-existent place.</p></li>
</ul>
</div></blockquote>
<dl>
<dt> &gt;&gt;&gt; cities.lookup(‘nonsense string’)</dt><dd><dl class="simple">
<dt>Traceback (most recent call last):</dt><dd><p>…</p>
</dd>
</dl>
<p>ValueError: Google cannot find a place named ‘nonsense string’</p>
</dd>
</dl>
<div class="section" id="transit-rising-setting">
<h3>transit, rising, setting<a class="headerlink" href="#transit-rising-setting" title="Permalink to this headline">¶</a></h3>
<blockquote>
...
for finding rising, transit, and setting times:</p>
...
and therefore to the observer’s <code class="docutils literal notranslate"><span class="pre">temp</span></code> and <code class="docutils literal notranslate"><span class="pre">pressure</span></code>;
...
for <code class="docutils literal notranslate"><span class="pre">temp</span></code> and <code class="docutils literal notranslate"><span class="pre">pressure</span></code>
...
<ul class="simple">
<li><p>Called without arguments.</p></li>
<li><p>Returns the sidereal time for the observer’s circumstances.</p></li>
</ul>
</div></blockquote>
<blockquote>
<div><div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">ra</span><span class="p">,</span> <span class="n">dec</span> <span class="o">=</span> <span class="n">madrid</span><span class="o">.</span><span class="n">radec_of</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="s1">&#39;90&#39;</span><span class="p">)</span>
...
<ul class="simple">
<li><p>Called like <code class="docutils literal notranslate"><span class="pre">radec_of(az,</span> <span class="pre">alt)</span></code>.</p></li>
<li><p>Returns the apparent topocentric coordinates
behind the given point in the sky.</p></li>
</ul>
</div></blockquote>
</div>
</div>
...
<blockquote>
<div><div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">a</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">degrees</span><span class="p">(</span><span class="s1">&#39;180:00:00&#39;</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="n">a</span><span class="p">)</span>
<span class="go">180:00:00.0</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">a</span>
<span class="go">3.141592653589793</span>
<span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="s2">&quot;180° is </span><span class="si">%f</span><span class="s2"> radians&quot;</span> <span class="o">%</span> <span class="n">a</span><span class="p">)</span>
<span class="go">180° is 3.141593 radians</span>
...
<span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="s2">&quot;1h right ascension = </span><span class="si">%s</span><span class="s2">°&quot;</span> <span class="o">%</span> <span class="n">deg</span><span class="p">)</span>
<span class="go">1h right ascension = 15:00:00.0°</span>
</pre></div>
</div>
<ul>
...
<span class="go">(1997, 3, 9, 5, 13, 2.3748725652694702e-07)</span>
...
<div class="section" id="local-time">
<h3>local time<a class="headerlink" href="#local-time" title="Permalink to this headline">¶</a></h3>
<blockquote>
<div><div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">d</span> <span class="o">=</span> <span class="n">ephem</span><span class="o">.</span><span class="n">Date</span><span class="p">(</span><span class="s1">&#39;1997/3/9 5:13&#39;</span><span class="p">)</span>
...
<span class="go">datetime.datetime(1997, 3, 9, 0, 13, 0, 6)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="n">ephem</span><span class="o">.</span><span class="n">localtime</span><span class="p">(</span><span class="n">d</span><span class="p">))</span>
<span class="go">1997-03-09 00:13:00.000006</span>
</pre></div>
</div>
<ul class="simple">
...
<span class="go">5:14:32.30 -8:12:06.0</span>
</pre></div>
</div>
<ul class="simple">
