...
<head>
  ...
  <title>Project Info &mdash; Western Meteor Physics Group Seismic and Infrasonic Meteor Program  documentation</title>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../../../../_sources/wmpl_venv/lib/python2.7/site-packages/pip-1.5.6.dist-info/DESCRIPTION.rst.txt" rel="nofollow"> View page source</a>
...
<ul class="simple">
<li><p>Project Page: <a class="reference external" href="https://github.com/pypa/pip">https://github.com/pypa/pip</a></p></li>
<li><p>Install howto: <a class="reference external" href="https://pip.pypa.io/en/latest/installing.html">https://pip.pypa.io/en/latest/installing.html</a></p></li>
<li><p>Changelog: <a class="reference external" href="https://pip.pypa.io/en/latest/news.html">https://pip.pypa.io/en/latest/news.html</a></p></li>
<li><p>Bug Tracking: <a class="reference external" href="https://github.com/pypa/pip/issues">https://github.com/pypa/pip/issues</a></p></li>
<li><p>Mailing list: <a class="reference external" href="http://groups.google.com/group/python-virtualenv">http://groups.google.com/group/python-virtualenv</a></p></li>
<li><p>Docs: <a class="reference external" href="https://pip.pypa.io/">https://pip.pypa.io/</a></p></li>
...
<p>First, <span class="xref std std-doc">Install pip</span>.</p>
<p>Install a package from <a class="reference external" href="http://pypi.python.org/pypi/">PyPI</a>:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ pip install SomePackage
  [...]
  Successfully installed SomePackage
</pre></div>
</div>
<p>Show what files were installed:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ pip show --files SomePackage
  Name: SomePackage
  Version: 1.0
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ pip install --upgrade SomePackage
  [...]
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ pip uninstall SomePackage
  Uninstalling SomePackage:
