...
<head>
  ...
  <title>Rising, Transit, Setting &mdash; Western Meteor Physics Group Seismic and Infrasonic Meteor Program  documentation</title>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../../../../../../../_sources/wmpl_venv/local/lib/python2.7/site-packages/pyephem-3.7.6.0-py2.7-linux-x86_64.egg/ephem/doc/rise-set.rst.txt" rel="nofollow"> View page source</a>
...
<h1>Rising, Transit, Setting<a class="headerlink" href="#rising-transit-setting" title="Permalink to this headline">¶</a></h1>
<div class="section" id="naval-observatory-risings-and-settings">
<h2>Naval Observatory Risings and Settings<a class="headerlink" href="#naval-observatory-risings-and-settings" title="Permalink to this headline">¶</a></h2>
...
<a class="reference internal" href="reference.html#Observer.pressure" title="Observer.pressure"><code class="xref py py-attr docutils literal notranslate"><span class="pre">pressure</span></code></a> of your observer to zero.  Then, manually set
...
printout shown above) with the <a class="reference internal" href="reference.html#Observer" title="Observer"><code class="xref py py-class docutils literal notranslate"><span class="pre">Observer</span></code></a> that we constructed
above with the correct pressure and horizon settings:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">atlanta</span><span class="o">.</span><span class="n">lat</span><span class="p">,</span> <span class="n">atlanta</span><span class="o">.</span><span class="n">lon</span> <span class="o">=</span> <span class="s1">&#39;33.8&#39;</span><span class="p">,</span> <span class="s1">&#39;-84.4&#39;</span>
...
<div class="section" id="computing-twilight">
<h2>Computing Twilight<a class="headerlink" href="#computing-twilight" title="Permalink to this headline">¶</a></h2>
...
<a class="reference internal" href="reference.html#Observer" title="Observer"><code class="xref py py-class docutils literal notranslate"><span class="pre">Observer</span></code></a> created in the section above to calculate the civil
twilight in Atlanta:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">atlanta</span><span class="o">.</span><span class="n">horizon</span> <span class="o">=</span> <span class="s1">&#39;-6&#39;</span>
