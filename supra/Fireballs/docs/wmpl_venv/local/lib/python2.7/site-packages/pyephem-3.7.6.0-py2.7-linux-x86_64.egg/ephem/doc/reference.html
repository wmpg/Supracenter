...
<head>
  ...
  <title>PyEphem Reference &mdash; Western Meteor Physics Group Seismic and Infrasonic Meteor Program  documentation</title>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>PyEphem Reference</li>
    
    
      <li class="wy-breadcrumbs-aside">
        
            
            <a href="../../../../../../../../_sources/wmpl_venv/local/lib/python2.7/site-packages/pyephem-3.7.6.0-py2.7-linux-x86_64.egg/ephem/doc/reference.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="pyephem-reference">
<h1>PyEphem Reference<a class="headerlink" href="#pyephem-reference" title="Permalink to this headline">¶</a></h1>
<p>The official documentation.</p>
<dl class="class">
<dt id="Observer">
<em class="property">class </em><code class="sig-name descname">Observer</code><a class="headerlink" href="#Observer" title="Permalink to this definition">¶</a></dt>
<dd><dl class="attribute">
<dt id="Observer.pressure">
<code class="sig-name descname">pressure</code><a class="headerlink" href="#Observer.pressure" title="Permalink to this definition">¶</a></dt>
<dd></dd></dl>

<p>The atmospheric pressure that you would like PyEphem to use when
...
know that the weather where you will be observing will be different.</p>
<p>If you set the pressure to zero, then you will turn off the PyEphem
